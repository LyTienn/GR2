...
export default function Bookshelves() {
  ...
  return (
    <div className="flex h-full bg-slate-50 relative">
      {/* Left pane: user list */}
      <aside className="w-[300px] flex flex-col border-r border-slate-200 bg-white shrink-0">
          ...
          {loading ? (
            ...
            filteredUsers.map((u) => {
              ...
              return (
                ...
                >
                  {isActive && <div className="absolute inset-0 bg-linear-to-r from-blue-100/50 to-transparent pointer-events-none" />}
